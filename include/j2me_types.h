...
// 常量类型
typedef enum {
    J2ME_CONSTANT_UTF8 = 1,
    J2ME_CONSTANT_INTEGER = 3,
    J2ME_CONSTANT_FLOAT = 4,
    J2ME_CONSTANT_LONG = 5,
    J2ME_CONSTANT_DOUBLE = 6,
    J2ME_CONSTANT_CLASS = 7,
    J2ME_CONSTANT_STRING = 8,
    J2ME_CONSTANT_FIELDREF = 9,
    J2ME_CONSTANT_METHODREF = 10,
    J2ME_CONSTANT_INTERFACE_METHODREF = 11,
    J2ME_CONSTANT_NAME_AND_TYPE = 12
...
typedef enum {
    ...
    J2ME_ERROR_UNCAUGHT_EXCEPTION,
    J2ME_ERROR_INVALID_CONSTANT_TYPE,
    J2ME_ERROR_INVALID_DESCRIPTOR,
    J2ME_ERROR_INCOMPATIBLE_CLASS_CHANGE
} j2me_error_t;
